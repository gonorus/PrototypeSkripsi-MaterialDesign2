...
public class FragmentNavigationDrawer_Adapter extends RecyclerView.Adapter<FragmentNavigationDrawer_Adapter.ViewHolder> {
    ...
    public FragmentNavigationDrawer_Adapter(List<ObjectMapsData> myDataset) {
        mDataset = myDataset;
    }

    @Override
    public FragmentNavigationDrawer_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
